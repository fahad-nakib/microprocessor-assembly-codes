...
PROCESS_ARRAY MACRO ARR, LEN
    ...
    XOR BX, BX                  ; Initialize sum of odd digits to BX
    XOR DX, DX                  ; Initialize sum of even digits to DX

PROCESS_LOOP:
    MOV AL, [SI]                ; Load current element into AL
    INC SI                      ; Move to next element

    MOV AH, 0                   ; Zero-extend AL to AX
    ...
    MOV BX,[SUM_ODD]
    ADD BX, AX                  ; Add to sum of odd digits
    MOV [SUM_ODD],BX
    JMP NEXT_ITERATION

ADD_TO_EVEN:
    ADD DX, AX                  ; Add to sum of even digits
