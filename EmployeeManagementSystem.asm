...
.data 
    ...
    heading db 10,13,  'EMPLOYEE MANAGEMENT SYSTEM: USER INTERFACE $'
        
    exitmsg db 10,13, 'SYSTEM CLOSED! $'
    
    createmsg db 10,13, 'CREATE NEW PROFILE $'

    detailmsg db 10,13,'YOUR PROFILE DETAILS $'

    withdrawmsg db 10,13, 'WITHDRAW $'

    DEPOSITMSG db 10,13, 'DEPOSIT $'

    resetmsg db 10,13,'CAUTION! YOU WILL RESET YOUR PROFILE $'

    modmsg db 10, 13, 'CAUTION! YOU WILL PROCEED TO MODIFY YOUR PROFILE $'

    mainmsg0 db 10,13,'0. Exit$'                         
    mainmsg1 db 10,13,'1. Create New Profile$'
    mainmsg2 db 10,13,'2. Retrieve Profile Details$'
    mainmsg3 db 10,13,'3. Withdraw Money$'
    mainmsg4 db 10,13,'4. Deposit Money$'
    mainmsg5 db 10,13,'5. Reset Profile$'
    mainmsg6 db 10,13,'6. Update Profile$'
    mainmsg8 db 10,13,'8. Retrieve All Profile$'
    mainmsg7 db 10,13,'Press Enter to return to main menu $'

    detailmsg1 db 10,13, 'Profile Name : $'
    detailmsg2 db 10, 13, 'Your City : $' 
    detailmsg3 db 10, 13, 'No Profile Currently Saved!!$' 
    ...
    create1 db 10,13,'1. Enter Profile Name : $'
    create2 db 10,13,'2. Enter Password :  $'
    ...
    create3 db 10,13,'Profile Created. $'
    ...
    modAccMsg1 db 10,13,'1. New Profile Name ( Old: $'
    modAccMsg2 db ' ) : >> $'
    modPinMsg1 db 10,13,'2. New Password ( Old: $' 
    modPinMsg2 db ' ) : >>$' 
    modSuccess db 10,13,'Profile Details Updated. $' 
    
    filename  db "..\..\emu8086\MySource\emu8086-project-master\users.txt", 0
    handle    dw ?
